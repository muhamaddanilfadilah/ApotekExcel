...
class OrderController extends Controller
{
    public function riwayat()
    {
        ...
        // Kembalikan view yang menampilkan riwayat pembelian
        return view('order.admin.riwayat', compact('orders'));
    }
    /**
    ...
    {
        //
        $orders=Order::where('created_at', 'LIKE', '%'.$request->search_date. '%')->orderBy('created_at')->simplePaginate(5);
